...
const App = () => {
  ...
  const handleDragEnd = (result) => {
    ...
    axios
      .put(`http://localhost:5000/api/tasks/${draggableId}`, { status: newStatus })
      .then(() => {
    ...
    <div className="app">
      ...
      <div className="footer-content">
        ...
        <div className="contact-links">
          <a href="https://github.com/Ashwithareddy12" target="_blank" rel="noopener noreferrer">
            <i className="fab fa-github"></i>
          </a>
          <a href="https://www.linkedin.com/in/ashwitha-antakala-028555252" target="_blank" rel="noopener noreferrer">
            <i className="fab fa-linkedin"></i>
          </a>
          <a href="mailto:ashwitha.antakala12@gmail.com">
